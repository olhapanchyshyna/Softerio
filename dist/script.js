...
function hamburger(openSelector, closeSelector, menuSelector, menuInformatiomSelector) {
  var moreInformation = document.querySelectorAll('.burger'),
    hideInformation = document.querySelectorAll('.burger-menu');
  moreInformation.forEach(function (item) {
    item.addEventListener('click', function () {
      hideInformation.forEach(function (inf) {
...
function services(btnsSelector, itemTextSelector) {
  ...
  var itemText = document.querySelectorAll(itemTextSelector);
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (event) {
      event.preventDefault();
      var indexBtn = btn.dataset.index;
      var item = document.querySelector("[data-text=\"".concat(indexBtn, "\"]"));
      var itemParent = item.closest('.services__item');
...
/* harmony import */ var _modules_moreInformation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/moreInformation */ "./src/js/modules/moreInformation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_modules_hamburger__WEBPACK_IMPORTED_MODULE_0__["default"])('.contact__icons-menu', '.contact__icons-close', '.contact__list', '.contact__information');
  (0,_modules_services__WEBPACK_IMPORTED_MODULE_1__["default"])('.services__item-button', '.services__item-text');
  (0,_modules_sliders__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_moreInformation__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_scrolling__WEBPACK_IMPORTED_MODULE_4__["default"])();
});
})();
